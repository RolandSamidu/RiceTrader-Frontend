  ...
  return (
    ...
    >
      ...
      <View style={tw`flex-row justify-between items-center p-4 bg-black bg-opacity-60`}>
        <Text style={tw`text-white text-2xl font-bold`}>Intermideator Dashboard</Text>
        <TouchableOpacity
      ...
      <View style={tw`flex-1 p-4 justify-center`}>
        ...
        <View style={tw`mb-16 items-center`}>
          <Text style={tw`text-3xl font-bold text-center`}>Welcome, {userName}!</Text>
          <Text style={tw`text-xl text-center mt-2`}>Manage your intermediary activities with ease.</Text>
        </View>
        ...
        <View style={tw`flex-row justify-around flex-wrap`}>
          ...
          >
            ...
            />
            <Text style={tw`text-lg font-semibold text-gray-800`}>Market Prices</Text>
          </TouchableOpacity>
